...
var TIMEZONE_ABBREVIATIONS = {
    ...
    'WET': ['Europe/Lisbon'],
    'WEST': ['Europe/Lisbon'],
    'CET': ['Europe/Paris', 'Europe/Berlin', 'Europe/Rome', 'Europe/Amsterdam', 'Europe/Brussels', 'Europe/Madrid', 'Europe/Vienna', 'Europe/Zurich', 'Europe/Stockholm', 'Europe/Oslo', 'Europe/Copenhagen', 'Europe/Warsaw', 'Europe/Prague', 'Europe/Budapest'],
    'CEST': ['Europe/Paris', 'Europe/Berlin', 'Europe/Rome', 'Europe/Amsterdam', 'Europe/Brussels', 'Europe/Madrid', 'Europe/Vienna', 'Europe/Zurich', 'Europe/Stockholm', 'Europe/Oslo', 'Europe/Copenhagen', 'Europe/Warsaw', 'Europe/Prague', 'Europe/Budapest'],
...
TimezonePicker.prototype.renderDropdown = function() {
    ...
    options.forEach(function(option) {
        ...
        option.addEventListener('mouseenter', function() {
            self.selectedIndex = parseInt(this.getAttribute('data-index'), 10);
            self.renderDropdown();
        });
    });
};
